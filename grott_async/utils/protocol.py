...
map_04_125 = {
        ...
        75: GrottRegister(75, RegType.FLOAT, 'pv5_energy_today', length=2, divide=10),
        77: GrottRegister(77, RegType.FLOAT, 'pv5_energy_total', length=2, divide=10),
        79: GrottRegister(79, RegType.FLOAT, 'pv6_energy_today', length=2, divide=10),
        81: GrottRegister(81, RegType.FLOAT, 'pv6_energy_total', length=2, divide=10),
        83: GrottRegister(83, RegType.FLOAT, 'pv7_energy_today', length=2, divide=10),
        85: GrottRegister(85, RegType.FLOAT, 'pv7_energy_total', length=2, divide=10),
        87: GrottRegister(87, RegType.FLOAT, 'pv8_energy_today', length=2, divide=10),
        ...
        110: GrottRegister(110, RegType.WARN_8, 'inverter_warning_bit', length=2, divide=1),
